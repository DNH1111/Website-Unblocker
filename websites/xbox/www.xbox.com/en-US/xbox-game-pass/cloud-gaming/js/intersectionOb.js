                    ...
                    if (!window.globFunctions) { window.globFunctions = {} }
                      ...
                      globFunctions.startVid =
                        function(id) {
                          ...
                          vid.play();
                          if (id === "vid1") {
                            $("#vid1").next("div").find("button").click();
                          }
                          if (id === "vid2") {
                            $("#vid2").next("div").find("button").click();
                          }
                        }


// For Page Bar
//  $(document).on("click", ".playLink", function() {
//    $(".playLink").attr("href", "https://www.xbox.com/play");
//  })
...
//     var url = "https://www.xbox.com/play"
